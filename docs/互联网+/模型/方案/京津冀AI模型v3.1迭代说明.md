...
> **前置文档**：[`京津冀AI模型精简方案-v3.md`](./京津冀AI模型精简方案-v3.md)、[`AI模型能力与本土化测试说明.md`](./AI模型能力与本土化测试说明.md)、[`ml-bjj训练操作手册-开发版.md`](../训练/ml-bjj训练操作手册-开发版.md)  
> **路线引用**：[`../下一阶段任务与流程.md`](../../规划/下一阶段任务与流程.md) §4.2 任务 B+1–B+3
...
因此项目规划了 **B+1 实地抽测 → B+2 难例回流 → B+3 可选重训** 的闭环（见 [`../下一阶段任务与流程.md`](../../规划/下一阶段任务与流程.md)）。
...
与 [`AI模型训练说明.md`](../训练/AI模型训练说明.md) §4.3 难例挖掘策略一致；预期实地一致率 **+3%–5%**（视样本量与质量而定）。
...
| [`../下一阶段任务与流程.md`](../../规划/下一阶段任务与流程.md) | B+1–B+3 总览 |
