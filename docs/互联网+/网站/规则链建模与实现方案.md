...
> **状态**：方案已定。V1.1 只调整阅读顺序，阈值与接口与 V1.0 相同。
...
| 文档 | 关系 |
|------|------|
| [`2.0非AI模块实现方案.md`](./2.0非AI模块实现方案.md) | 总方案；本文是其规则链子文档 |
| [`智慧决策页面重构方案.md`](./智慧决策页面重构方案.md) | 决策页消费本文产出的预警 |
| [`防治知识库实现方案.md`](./防治知识库实现方案.md) | 链 3 / `[AI识别]` 的防治文案 |
| [`新模型训后-P3-规则链与工程化实施计划.md`](./新模型训后-P3-规则链与工程化实施计划.md) | Flask 侧「病名 × 当前环境」；**不替代**本文三条链 |
